...
class Weather extends React.Component {
  ...
  getWeather = async (lat, lon) => {
    ...
    // cityStyle={backgroundImage:`url(${data.weather[0].main}.jpg)`}
    this.setState({
      lat: lat,
      lon: lon,
      city: data.name,
    ...
    if (this.state.temperatureC) {
      return (
        ...
        <React.Fragment>
          <div className="city" >
            <div className="title">
              <h2>{this.state.city},<span className="black">{this.state.country}</span></h2>
